...
var Color = (function () {
    ...
    Color.prototype.friendlyName = function(){
        var hex =  this.toHex();
        for(var key in __system_colors__) {
            if(__system_colors__[key] == hex) {
                return key;
            }
        }
        return hex;
