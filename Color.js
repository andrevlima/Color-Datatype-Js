...
var Color = (function () {
	...
	Color.prototype.toRGB = function(outputType) {
    ...
    Color.prototype.friendlyName = function(){
        var hex =  this.toHex();
        for(var key in Color.register.__system_colors__) {
            if(Color.register.__system_colors__[key] == hex) {
                return key;
            }
        }
        return hex;
